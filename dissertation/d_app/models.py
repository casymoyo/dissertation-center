...
class dissertation(models.Model):
    ...
    tech = models.CharField(max_length = 50, choices = options, default = '', blank = True)
    tech_stack = models.CharField(max_length = 50, choices = options_stack, default = '', blank = True)
